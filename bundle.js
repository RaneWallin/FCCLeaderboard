...
/***/ function(module, exports, __webpack_require__) {
	...
	var _campers = __webpack_require__(208);

	var _campers2 = _interopRequireDefault(_campers);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_campers2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _table_sorter = __webpack_require__(239);

	var _table_sorter2 = _interopRequireDefault(_table_sorter);
	...
	var Campers = function (_Component) {
		_inherits(Campers, _Component);

		function Campers() {
			_classCallCheck(this, Campers);

			return _possibleConstructorReturn(this, (Campers.__proto__ || Object.getPrototypeOf(Campers)).apply(this, arguments));
		}

		_createClass(Campers, [{
			...
			key: 'renderCampers',
			value: function renderCampers(campers) {
				var fccUrl = "https://www.freecodecamp.com/";
				if (!this.props.campers) return "";

				return campers.map(function (camper, i) {
					return _react2.default.createElement(
						'tr',
						{ key: camper.username },
						...
						_react2.default.createElement(
							'td',
							null,
							_react2.default.createElement('img', { className: 'camper-img', src: camper.img }),
							_react2.default.createElement(
								'a',
								{ href: fccUrl + camper.username, target: '_blank' },
								camper.username
							)
						),
						_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(_table_sorter2.default, { title: 'Camper Name', which: 'username' }),
								_react2.default.createElement(_table_sorter2.default, { title: 'Points in past 30 days', which: 'recent' }),
								_react2.default.createElement(_table_sorter2.default, { title: 'All time points', which: 'alltime' })
							)
						),
						_react2.default.createElement(
							'tbody',
	...
	function mapStateToProps(_ref) {
		var campers = _ref.campers;

		return { campers: campers.data };
	}

	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)({ fetchCampers: _index.fetchCampers }, dispatch);
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Campers);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SORT_CAMPERS = exports.FETCH_CAMPERS = undefined;
	exports.fetchCampers = fetchCampers;
	exports.sortCampers = sortCampers;
	...
	var SORT_CAMPERS = exports.SORT_CAMPERS = 'SORT_CAMPERS';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TableSorter = function (_Component) {
		...
		function TableSorter(props) {
			...
			var _this = _possibleConstructorReturn(this, (TableSorter.__proto__ || Object.getPrototypeOf(TableSorter)).call(this, props));
	...
	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)({ sortCampers: _index.sortCampers }, dispatch);
	}
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(TableSorter);
	...
	var SiteHeader = function SiteHeader() {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					"a",
					{ href: "https://github.com/RaneWallin/FCCLeaderboard/tree/gh-pages" },
					"GitHub"
				)
			)
		);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer_camper_list = __webpack_require__(242);

	var _reducer_camper_list2 = _interopRequireDefault(_reducer_camper_list);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  campers: _reducer_camper_list2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		...
		switch (action.type) {
			...
			case _index.SORT_CAMPERS:
				var which = action.which;

				// cloning the whole state object is problematic
				// so just pulling out the parts we need to
				// build the newwState
				newState.data = [].concat(_toConsumableArray(state.data));
				newState.which = which;
				newState.way = state.way;

				if (which == state.which) newState.way *= -1;else newState.way = 1;
				...
				// that tab
				newState.data = sortMe(newState.data, which, newState.way);
		...
		switch (type) {
			case 'username':
				data = data.sort(function (a, b) {
					if (b[type].toLowerCase() > a[type].toLowerCase()) return -way;
					if (b[type].toLowerCase() < a[type].toLowerCase()) return way;else return 0;
				});
				break;
			case 'alltime':
			case 'recent':
				data = data.sort(function (a, b) {
					if (b[type] > a[type]) return way;
					if (b[type] < a[type]) return -way;else return 0;
				});
		}
